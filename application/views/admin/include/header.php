					...
					<li class="nav-item dropdown hidden-caret">
						...
						<ul class="dropdown-menu dropdown-user animated fadeIn">
							<div class="dropdown-user-scroll scrollbar-outer">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="<?=base_url() ?>pub/upload/img/avt/<?=$adm['anh']?>" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4><?=$adm['ho_ten']?></h4>
											<p class="text-muted"><?=$adm['email']?></p><a href="<?=base_url()?>admin/users/admin/edit<?=$adm['id']?>" class="btn btn-xs btn-secondary btn-sm">Thông tin</a>
										</div>
									</div>
								</li>
								<li>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="<?=base_url() ?>admin/home/logout">Đăng xuất</a>
								</li>
							</div>
						</ul>
					</li>
