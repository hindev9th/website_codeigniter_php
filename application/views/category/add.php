			...
			<div class="page-inner py-5">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					...
					<div class="ml-md-auto py-2 py-md-0">
						<a href="../category" class="btn btn-secondary btn-round" id="btn-back">Quay lại</a>
					</div>
				</div>
			</div>
		</div>
								...
								<div class="col-md-4">
									<div class="table-responsive table-hover table-sales" id="table-data">
										<form action="<?= base_url() ?>index.php/category/insert" method="post">
											...
											<input type="text" name="Ma_DM" id="Ma_DM" placeholder="Mã danh mục" class="form-control">
											<label for="Ten_DM" class="mt-2 mb-0">Tên danh mục</label>
											<input type="text" name="Ten_DM" id="Ten_DM" placeholder="Tên danh mục" class="form-control">
